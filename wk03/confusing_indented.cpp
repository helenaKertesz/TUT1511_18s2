...
int tritest(double x0,double y0,double x1,double y1,double
      x2,double y2,double px, double py){
...
int main(int argc, char* argv[]) {
   ...
   scanfsReturnValueAggregatedOverAllScanfs += scanf("%lf,%lf",
         &x0,&y0);
   ...
   if(tritest(x0,y0,x1,y1,x2,y2,px,py)){ // if point inside triangle pointInsideTriangle
      printf("inside");
   } else {
      printf("outside");
      printf(" the Triangel\n");
